...
my $wall = SDLx::Sprite->new( image => "img/room/tree-small.png" ) or die("Could not load wall image!"); #Load the wall image
...
#.#.#..######..#.###...#.#ww########..#####
 #....#wwwwww.##.#.######wwwwwwwwwwww.#    
  ...
  #.........##......#.......#.............#
  #.#######.wwwwwwwww.#########.###########
  #.########wwwwwwwww..wwwwwwww..wwwwwww#.#
  #...#.....wwwwwwwwww.wwwwwwww#.wwwwwww#.#
 #....#####.wwwwwwwwww..wwwwwww..wwwwwww#.#
#..##.......wwwwwwwwwww..wwwwww.wwwwwwww#.#
#.#ww#.####..wwwwwwwwwww.#.........######.#
#.#ww#.....#.............#########........#
#..##..###.############..wwwwwwwww.########
 #....#www.....wwwww....wwwwwwwwww.###     
  #.##wwwwww.#.wwwwww.wwwwwwwwwwww...#     
  #..#wwwwww.##wwwwww.wwwwwwwwwwwwww.#     
  ##.#wwwwww.#.######..#############.######
  #.................#...........#....#....#
  ####.wwwwwwwwwwwwwwww.#######.##.######.#
...
sub initWorld {
  ...
  for my $x (0 .. $#room) {
    for my $y (0 .. $#{$room[$x]}) {
      my $char = $room[$x][$y]; 
      if ($char eq 'p') {
        Entity::Player::initPlayer(["img/player/assassin/down.png","img/player/assassin/left.png","img/player/assassin/right.png","img/player/assassin/behind.png"], [$x, $y], $offset);
      }
    }
  }
}
